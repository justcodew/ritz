...
- **现状**：0.2.0，单人项目，2026 开发，**继承 MuPDF 实场稳健性 + 在多个场景 2–10x 快于 PyMuPDF + Phase 5a 读路径（search_for / get_toc）**
...
**49 个 pytest 必须全绿。这是合并任何 PR 的硬门。**
...
6. **Phase 5b：注释读写** `page.get_annots()` + `add_highlight/underline/strikeout/text`
7. **Phase 5c：大纲写入** `doc.set_toc()`
